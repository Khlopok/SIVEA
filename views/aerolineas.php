<?php require_once './views/includes/navigation.php' ?>
    <div class="main-container">
        ...
        <main class="aerolineas">
        <?php require_once './views/includes/alert_modal.php' ?>
            <div class="base-table-container">
                <div class="base-table-components">
                    <a href="<?php base_url() ?>/aerolinea/crear">
                        <button class="base-button" title="Nueva Aerolinea">Registrar</button>
                    </a>
                    <input type="search" placeholder="Busqueda">
                </div>
                <table class="base-table" controller="Aerolinea">
