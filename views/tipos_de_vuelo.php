<?php require_once './views/includes/navigation.php' ?>
    <div class="main-container">
        ...
        <main class="tipos-vuelo">
        <?php require_once './views/includes/alert_modal.php' ?>
            <div class="base-table-container">
                <div class="base-table-components">
                    <a href="<?php base_url() ?>/tipovuelo/crear">
                        <button class="base-button" title="Nuevo Tipo De Vuelo">Registrar</button>
                    </a>
                    <input type="search" placeholder="Busqueda">
                </div>
                <table class="base-table" controller="Tipovuelo">
                    ...
                    <tbody class="base-table-body"></tbody>
                </table>
